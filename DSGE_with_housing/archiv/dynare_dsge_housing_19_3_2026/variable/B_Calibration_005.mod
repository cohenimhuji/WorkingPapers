...
p_gamma_tag = 0.603; // 18.9.23 Nimrod. was updated to keep ownership to rent ratio 1.6 //0.65, 0.75 weight of ownership of constrained in the H (CES) function
...
ro_shock_ltv_all=0.9999; ////serial correlation of the LTV shock. High serial correlation means that agents expect that change in leverage will take place for a long time
ro_shock_ltv_old=0.9999; ////serial correlation of the LTV shock. High serial correlation means that agents expect that change in leverage will take place for a long time
...
alpha = 0.05 ; % The share of young households that buy with regulatory ltv
