...
//new equation for lagrangian multiplier for internilizeg , Ninmrod 5/5/2026 
    lagr_Lambda =  lambda_tag * B_tag / ( 1- ref - 1/p_beta_tag ) ;
...
DP_q_nominal_annulized = (DP_cpi - 1 )*400;
