...
Variabels_4_4_Test = {'LY','DP_cpi_a', 'r_a', 'rL_a', ... 
                'Lh_o',  'Lh_r','LC', 'L_h_inv', ...
                'DP_rent_nominal_annulized','Lh_r_tag','DP_q_nominal_annulized', 'LB_tag', ...
                'DP_r_a', 'Lr', 'Lq', 'LB_tag_n'};
...
% to tsest
irfs_models_d({Baseline_Test, Scenario_Tight_LTV}, 0, Variabels_4_4_Test, {'eps_CB'},{'Baseline ($\overline{LTV}=66\%$)','Tight LTV ($\overline{LTV}=56\%$)'});
