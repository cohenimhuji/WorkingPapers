...
p_alfa=0; //0.02/4;  //spread LTV relationship in Ilek and Cohen (2023). Division by 4 beucase here the interest rate in quarterly terms
...
p_gamma =0.499214 + 0.171975 ; //0.75 weight of ownership of unconstrained in the H (CES) function
p_gamma_tag = 0.653 +0.04051; //0.603 // 18.9.23 Nimrod. was updated to keep ownership to rent ratio 1.6 //0.65, 0.75 weight of ownership of constrained in the H (CES) function
eps=10*0+2; //elasticity of substitution betwen rent and ownership
p_gamma_au = (1-p_gamma)/p_gamma; //auxilary ratio
p_gamma_au_tag = (1-p_gamma_tag)/p_gamma_tag; //auxilary ratio
p_ltv   = 0.66-0*0.1; // 18.9.23 Nimrod. before it was  0.55; //0.53 , LTV ratio in SS. Based on average LTV from 2011-2023 from Mortage file, sheet 18.
k       = 0; //adjustment costs (5% of the value of transaction)
tau     =  1 - (0.312+0*0.038) ; //ratio of unconstrained households in the economy 
...
p_ltv_old = 0.0172; % from Alpanda and Zubairy (2018) 
ref = 0.05 ;% based on Israeli data
